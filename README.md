...
This repository contains the files required to get started with a go module
...
1. Edit the .circleci/config.yml - replace "go-service-template" and "Serivice Name" with the actual values
...
1. Add the service to the [lsk-service-registry](https://github.com/lightspeed-hospitality/SRE/tree/main/lsk-service-registry)
